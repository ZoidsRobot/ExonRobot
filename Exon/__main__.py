...
buttons = [
    ...
    [
        InlineKeyboardButton(text="❓ ʙᴀɴᴛᴜᴀɴ", callback_data="ABG_support"
       ),
...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        # kb.append([InlineKeyboardButton(text='sᴜᴘᴘᴏʀᴛ', url='https://t.me/ZOIDsSupport'),
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_photo(
                f"@{SUPPORT_CHAT}",
                photo="https://telegra.ph/file/e684d81a846cb6a8369ef.jpg",
                caption=f"""
